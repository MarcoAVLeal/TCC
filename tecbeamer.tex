...
% Theme setup
%\titlegraphic{\includegraphics[scale=0.4]{Figures/logoTEC_full.png}}
...
\usepackage{tikz}
%\setbeamertemplate{background}{\tikz[overlay,remember picture]\node[opacity=0.35]at (current page.center){\includegraphics[width=6cm]{Figures/logo_pastel.png}};}
